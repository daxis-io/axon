...
| Daxis first-class integration contracts stay fixture-backed and hash-pinned                                       | `docs/integrations/daxis/daxis-first-class-integration-examples/`, `docs/release-gates/daxis-contract-artifacts.sha256`, `cargo test -p query-contract`, and `bash tests/conformance/verify_daxis_contract_artifacts.sh`                                                                                                                                                                                                                |
