...
fn query_response_serializes_without_absent_fallback_reason() {
    let response = QueryResponse {
        ...
        metrics: QueryMetricsSummary {
            ...
            range_cache_hits: None,
            range_cache_misses: None,
            range_cache_bytes_reused: None,
            range_cache_bytes_stored: None,
            range_cache_validation_misses: None,
            range_cache_degraded_identity_reads: None,
            range_readahead_requests: None,
            range_readahead_bytes_fetched: None,
            range_readahead_bytes_used: None,
            range_readahead_wasted_bytes: None,
...
fn query_response_serializes_browser_telemetry_when_present() {
    let response = QueryResponse {
        ...
        metrics: QueryMetricsSummary {
            ...
            prebootstrap_candidate_files: Some(3),
            row_groups_touched: 5,
            row_groups_skipped: 2,
            footer_reads: Some(3),
            ...
            range_cache_hits: Some(11),
            range_cache_misses: Some(12),
            range_cache_bytes_reused: Some(800),
            range_cache_bytes_stored: Some(2_560),
            range_cache_validation_misses: Some(1),
            range_cache_degraded_identity_reads: Some(2),
            range_readahead_requests: Some(3),
            range_readahead_bytes_fetched: Some(4_096),
            range_readahead_bytes_used: Some(3_072),
            range_readahead_wasted_bytes: Some(1_024),
    ...
    assert_eq!(
        ...
        serde_json::json!({
            ...
            "metrics": {
                ...
                "range_cache_hits": 11,
                "range_cache_misses": 12,
                "range_cache_bytes_reused": 800,
                "range_cache_bytes_stored": 2560,
                "range_cache_validation_misses": 1,
                "range_cache_degraded_identity_reads": 2,
                "range_readahead_requests": 3,
                "range_readahead_bytes_fetched": 4096,
                "range_readahead_bytes_used": 3072,
                "range_readahead_wasted_bytes": 1024,
