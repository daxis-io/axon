...
default_artifacts=(
  ...
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.batch-sign-request.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.batch-sign-response.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.head-request.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.head-response.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.list-request.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.list-response.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/object-grants.range-request.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.agent.executed.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.api.executed.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.builder.executed.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.dashboard-tile.executed.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.policy-denied.rejected.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.runtime-budget-overflow.fallback.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.saved-query.executed.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/query-result.unsupported-sql.fallback.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/read-access-plan.blocked.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/read-access-plan.brokered-delta.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/read-access-plan.delta-sharing.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/read-access-plan.sql-fallback-required.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-request.latest.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-request.version-42.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-response.expired.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-response.invalid-descriptor.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-response.path-escape.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-response.signed-url.json"
  "docs/integrations/daxis/daxis-first-class-integration-examples/snapshot-descriptor-response.snapshot-version-mismatch.json"
)
