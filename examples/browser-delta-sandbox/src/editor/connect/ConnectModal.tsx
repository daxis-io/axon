...
export function ConnectModal({ initialStep = 1, initialSource = null, onClose, onConnect }: Props) {
      ...
      <div className="cc-modal" role="dialog" aria-labelledby="cc-modal-title">
        ...
        <div className="cc-body">
          ...
          {step === 2 && source === 'object_store' && (
            <ConfigObjectStore form={form} setForm={setForm} testState={testState} />
          )}
    ...
    <div className="cc-config-grid">
      ...
      <aside className="cc-helper">
        ...
        <p>
          ...
          Native fallback kicks in automatically if a table requires features WASM can&apos;t serve.
        </p>
        <hr />
